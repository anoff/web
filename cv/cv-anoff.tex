...
\skills{acquired skills}{Python, GitHub, Trainings, Change Management}
}
\end{entrylist}
...
{Create Matlab Simulink model for motorcycle ABS systems.

\skills{acquired skills}{Matlab, Systems Engineering, GUI design}
}
\end{entrylist}
