...
{I joined Bosch Japan to drive the Digitalization efforts in their automotive engineering section. Special focus was on the area of Systems and Software development - having a solid foundation in this area and experience with developing state of the art solutions and a data mindset was a must. During my assignment I developed training concepts for AI and coordinated several activities to improve our engineering efficiency. In addition I work on developing automated & connected IT solutions to replace manual processes and reduce the time to complete the tasks. Solutions are built using Python and deployed via Docker containers using CICD methods.}

\skills{acquired skills}{Python, training concepts, organizational change, leadership}
}
\end{entrylist}
